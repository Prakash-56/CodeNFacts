...
"6.4 Portfolio Deployment on GitHub",
    ...
    projects: [
      "Stock Analysis Dashboard (Pandas + Plotly + Streamlit)",
      "Healthcare Data Pipeline (cleaning + EDA + insights)",
      "Sentiment Analysis Tool (text processing + ML classifier)",
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "Perfect! Absolute beginner curriculum with visual explanations.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes! 3 GitHub-ready projects + resume templates provided.",
      },
    ],
  },
...
"5.4 Mini E-Commerce Backend",
    ...
    projects: [
      "ATM Banking System (OOP + Collections + File I/O)",
      "Library Management System (Interfaces + Generics + Streams)",
      "Student Portal Application (Records + Exception Handling + JUnit tests)",
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "Records, sealed classes, pattern matching - latest LTS features included.",
      },
      {
        question: "University aligned?",
        answer:
          "100% B.Tech/MCA syllabus + 200 extra interview questions.",
      },
      {
        question: "IDE used?",
        answer:
          "IntelliJ IDEA Community (industry standard, free forever).",
      },
    ],
  },
...
"5.6 Sorting Algorithms - Bubble, Merge, Quick in C",
    ...
    projects: [
      "Scientific Calculator (all operators + math.h functions)",
      "Console Snake Game (2D array + keyboard input + game loop)",
      "Student Database (structures + file I/O + CRUD operations)",
      "File Encryption Tool (XOR cipher + file read/write)",
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "Builds unbreakable logic foundation - powers Linux, games, embedded systems.",
      },
      {
        question: "Compiler setup?",
        answer:
          "GCC + Code::Blocks (Windows) / VS Code (all platforms) - step-by-step install guide.",
      },
      {
        question: "Pointers explained?",
        answer:
          "Visual diagrams → Code → Real memory examples - 3 learning layers.",
      },
    ],
  },
...
"4.6 Performance - Critical CSS, Will-Change, Repaints",
    ...
    projects: [
      "Personal Portfolio Website (fully responsive, hosted on Netlify)",
      "Netflix Landing Clone (Grid layout + animations + responsive)",
      "E-commerce Product Page (Flexbox + Tailwind + CSS variables)",
      "Admin Dashboard UI (CSS Grid + dark mode + container queries)",
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "Yes! 80% client work uses these skills + Figma-to-code conversion.",
      },
      {
        question: "Next after CSS?",
        answer:
          "JavaScript → React (clear learning path with discounts).",
      },
      {
        question: "Projects deployed?",
        answer:
          "All 4 projects hosted on Netlify + GitHub repos created.",
      },
    ],
  },
...
"6.4 LeetCode Patterns - Top 75 Problem Walkthrough",
    ...
    projects: [
      "LeetCode Top 100 Solver (annotated solutions in chosen language)",
      "Graph Visualizer (BFS/DFS step-by-step web app)",
      "DP Toolkit (interactive pattern explorer)",
      "Sorting Simulator (visual comparison of all sort algorithms)",
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "C++/Java/Python - pick one, master optimal solutions for all.",
      },
      {
        question: "Beginner ok?",
        answer:
          "Yes! Logic foundation + pattern recognition taught from scratch.",
      },
      {
        question: "Mock interviews?",
        answer:
          "5 live FAANG-style interviews + detailed feedback sessions.",
      },
    ],
  },
...
"15.6 AI Ethics & Responsible AI"
    ...
    projects: [
      "House Price Predictor (Ridge/XGBoost + feature engineering + Flask API)",
      "Face Recognition Attendance System (OpenCV + CNN + real-time webcam)",
      "Customer Churn Prediction (ensemble models + SHAP explainability)",
      "Image Classifier Web App (Transfer Learning + Docker + CI/CD)",
    ],
    ...
    faqs: [
      {
        question: "Math heavy?",
        answer:
          "Intuition → Math → Code. Easier than college textbooks.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "From scratch implementation + TensorFlow/Keras production.",
      },
    ],
  },
...
"6.4 Building a Data Science Portfolio - 5 Project Ideas",
    ...
    projects: [
      "Uber Analytics Dashboard (SQL + Tableau interactive story)",
      "Fraud Detection Pipeline (XGBoost + SHAP + FastAPI + Docker)",
      "Sales Forecast System (Time series + cloud deployment + monitoring)",
    ],
...
"5.5 Domain, SSL & Production Checklist",
    ...
    projects: [
      "Full E-commerce MERN (products, cart, payments, admin dashboard)",
      "Real-time Chat App (Socket.io + auth + rooms)",
      "SaaS Dashboard (Next.js 15 + Stripe + multi-tenant auth)",
      "Blog CMS (Next.js + MDX + ISR + admin panel)",
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "100% TypeScript - industry standard for production apps.",
      },
      {
        question: "Deployment covered?",
        answer:
          "All projects deployed to Vercel + custom domains provided.",
      },
      {
        question: "Internship guarantee?",
        answer:
          "Top performers get internship referrals to partner companies.",
      },
    ],
  },
...
"5.5 Tracking Metrics & Profile Analytics",
    ...
    projects: [
      "Fully Optimized LinkedIn Profile (targeting 5x profile views in 30 days)",
      "30-Day Content Calendar (topic, format, hook & hashtags for each post)",
      "Recruiter Outreach Plan (target list + personalized DM scripts)",
    ],
